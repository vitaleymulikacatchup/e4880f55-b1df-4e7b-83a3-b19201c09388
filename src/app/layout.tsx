...
export const metadata: Metadata = {
  title: "Brown Café - Fresh Food & Cozy Atmosphere",
  description: "Experience the perfect blend of comfort and flavor at Brown Café. Fresh daily specials, artisan coffee, and warm hospitality in a cozy setting.",
  keywords: "cafeteria, coffee, fresh food, daily specials, cozy dining, artisan coffee, healthy meals",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Brown Café - Fresh Food & Cozy Atmosphere",
    description: "Experience the perfect blend of comfort and flavor at Brown Café. Fresh daily specials, artisan coffee, and warm hospitality.",
    siteName: "Brown Café",
    type: "website",
    images: [{
  ...
  twitter: {
    ...
    title: "Brown Café - Fresh Food & Cozy Atmosphere",
    description: "Experience the perfect blend of comfort and flavor at Brown Café.",
